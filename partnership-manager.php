...
defined('WP_PARTNERSHIPM_BUILD_URI') || define('WP_PARTNERSHIPM_BUILD_URI', untrailingslashit(WP_PARTNERSHIPM_DIR_URI) . '/assets/build');
defined('WP_PARTNERSHIPM_BUILD_PATH') || define('WP_PARTNERSHIPM_BUILD_PATH', untrailingslashit(WP_PARTNERSHIPM_DIR_PATH) . '/assets/build');
defined('WP_PARTNERSHIPM_BUILD_JS_URI') || define('WP_PARTNERSHIPM_BUILD_JS_URI', untrailingslashit(WP_PARTNERSHIPM_DIR_URI) . '/assets/build/js');
defined('WP_PARTNERSHIPM_BUILD_JS_DIR_PATH') || define('WP_PARTNERSHIPM_BUILD_JS_DIR_PATH', untrailingslashit(WP_PARTNERSHIPM_DIR_PATH) . '/assets/build/js');
defined('WP_PARTNERSHIPM_BUILD_IMG_URI') || define('WP_PARTNERSHIPM_BUILD_IMG_URI', untrailingslashit(WP_PARTNERSHIPM_DIR_URI) . '/assets/build/src/img');
defined('WP_PARTNERSHIPM_BUILD_CSS_URI') || define('WP_PARTNERSHIPM_BUILD_CSS_URI', untrailingslashit(WP_PARTNERSHIPM_DIR_URI) . '/assets/build/css');
defined('WP_PARTNERSHIPM_BUILD_CSS_DIR_PATH') || define('WP_PARTNERSHIPM_BUILD_CSS_DIR_PATH', untrailingslashit(WP_PARTNERSHIPM_DIR_PATH) . '/assets/build/css');
defined('WP_PARTNERSHIPM_BUILD_LIB_URI') || define('WP_PARTNERSHIPM_BUILD_LIB_URI', untrailingslashit(WP_PARTNERSHIPM_DIR_URI) . '/assets/build/library');
