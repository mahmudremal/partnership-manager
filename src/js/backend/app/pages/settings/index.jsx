  ...
  return (
      <div className="card xpo_h-100 xpo_p-0 radius-12">
          <div className="card-header xpo_border-bottom bg-base py-16 px-24 xpo_flex xpo_items-center xpo_flex-wrap xpo_gap-3 xpo_justify-between">
              ...
              <button className="btn btn-primary text-sm btn-sm px-12 py-12 radius-8 xpo_flex xpo_items-center xpo_gap-2" onClick={handleUpdate} >
                  { updating == 1 ? <Loader className="xpo_icon text-xl xpo_line-height-1 xpo_animate-spin" /> : (
                    updating == 2 ? <CheckCheck className="xpo_icon text-xl xpo_line-height-1" /> : <Save className="xpo_icon text-xl xpo_line-height-1" />
                  ) }
                  {__('Update')}
              </button>
          </div>
