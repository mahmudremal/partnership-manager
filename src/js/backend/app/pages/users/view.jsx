                            ...
                            <div className="mt-24">
                                ...
                                <ul>
                                    ...
                                    <li className="xpo_gap-2">
                                        ...
                                        <p className="w-70 text-secondary-light fw-medium">{user.metadata?.description??''}</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
export const ProfileView = ({ user: userData, user_id: userId = null }) => {
    ...
    useEffect(() => {
        setLoading(true);
        request(rest_url(`/partnership/v1/users/${user_id}`))
            ...
            {userData ? (
                ...
                <div>
                    <div class="alert alert-danger bg-danger-100 text-danger-600 border-danger-100 px-24 py-11 mb-0 fw-semibold text-lg radius-8" role="alert">
                        ...
                        <p class="fw-medium text-danger-600 text-sm mt-8">{__('If you didn\'t get this error that means either this profile removed, paused or archive forever. Please contact with support if you want to get access to this person personally.')}</p>
                    </div>
                </div>
            ) : null}
        </div>
