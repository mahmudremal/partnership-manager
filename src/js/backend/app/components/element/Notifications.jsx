...
export default function Notifications() {
    ...
    return (
        <div className="dropdown">
            ...
            <div className="m-16 py-12 px-16 radius-8 bg-primary-50 mb-16 xpo_flex xpo_items-center xpo_justify-between gap-2">
                <div>
                    <h6 className="text-lg text-primary-light fw-semibold mb-0">{__('Notifications')}</h6>
                </div>
                <span className="text-primary-600 fw-semibold text-lg w-40-px h-40-px rounded-circle bg-base xpo_flex justify-content-center xpo_items-center">{notifications?.length ?? 0}</span>
            </div>
...
const NotificationItem = ({ args = {} }) => {
    ...
    return (
        <Link to={to} className={`px-24 py-12 xpo_flex align-items-start gap-3 mb-2 xpo_justify-between ${!seen ? "bg-neutral-50" : ""}`}>
            <div className="text-black hover-bg-transparent hover-text-primary xpo_flex xpo_items-center gap-3">
                <span className={`w-44-px h-44-px ${bg} rounded-circle xpo_flex justify-content-center xpo_items-center flex-shrink-0`}>
