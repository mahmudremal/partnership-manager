...
class Task {
    ...
    public function get_post_data( WP_REST_Request $request ) {
        ...
        if ( ! $post || $post->post_type !== $post_type ) {
            return new WP_Error( 'rest_invalid_id', __( 'Invalid post ID or post type.', 'wp-partnershipm' ), array( 'status' => 404 ) );
        }
