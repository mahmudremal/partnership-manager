...
class Visitor {
    ...
    public function register_routes() {
        ...
        register_rest_route('partnership/v1', '/activities/(?P<activity_id>\d+)', [
            'methods'             => 'GET',
            ...
            'args'                => [
                'activity_id' => [
                    ...
                    'description'       => __('Activity ID for fetching details.', 'wp-partnershipm'),
                    'required'          => true,
                ],
            ],
        ]);
        ...
        register_rest_route('partnership/v1', '/activities/(?P<activity_id>\d+)', [
            ...
            'args'                => [
                'activity_id' => [
                    ...
                    'description'       => __('Activity ID for deletion.', 'wp-partnershipm'),
                    'required'          => true,
                ],
            ],
        ]);
        ...
        register_rest_route('partnership/v1', '/activities/(?P<activity_id>\d+)', [
            ...
            'args'                => [
                'activity_id' => [
                    ...
                    'description'       => __('Activity ID for updating; use 0 to create a new activity.', 'wp-partnershipm'),
                    'required'          => true,
                ],
                'visitor_id' => [
                    'validate_callback' => function($param) { return is_numeric($param) && $param > 0; },
                    'description'       => __('Visitor ID associated with the activity.', 'wp-partnershipm'),
                    'required'          => true,
                ],
                'activity' => [
                    'validate_callback' => function($param) { return !empty($param); },
                    'description'       => __('Description of the activity.', 'wp-partnershipm'),
                    'required'          => true,
                ],
            ],
        ]);
        ...
        register_rest_route('partnership/v1', '/visitors/(?P<visitor_id>\d+)', [
            'methods'             => 'GET',
            ...
            'args'                => [
                'visitor_id' => [
                    'validate_callback' => function($param) { return is_numeric($param); },
                    'description'       => __('Visitor ID for fetching details.', 'wp-partnershipm'),
                    'required'          => true,
                ],
            ],
        ]);
        ...
        register_rest_route('partnership/v1', '/visitors/(?P<visitor_id>\d+)', [
            ...
            'args'                => [
                'visitor_id' => [
                    'validate_callback' => function($param) { return is_numeric($param) && $param > 0; },
                    'description'       => __('Visitor ID for deletion.', 'wp-partnershipm'),
                    'required'          => true,
                ],
            ],
        ]);
        ...
        register_rest_route('partnership/v1', '/visitors/(?P<visitor_id>\d+)', [
            ...
            'args'                => [
                'visitor_id' => [
                    'validate_callback' => function($param) { return is_numeric($param); }, // ID can be 0 for create
                    'description'       => __('Visitor ID for updating; use 0 to create a new visitor.', 'wp-partnershipm'),
                    'required'          => true,
                ],
                'tracker' => [
                    'validate_callback' => function($param) { return !empty($param); },
                    'description'       => __('Tracker code for the visitor.', 'wp-partnershipm'),
                    'required'          => true,
                ],
                'user_id' => [
                    'validate_callback' => function($param) { return is_numeric($param) || is_null($param); },
                    'description'       => __('User ID associated with the visitor; can be null.', 'wp-partnershipm'),
                    'required'          => false,
                ],
                'dataset' => [
                    'validate_callback' => function($param) { return is_string($param) || is_null($param); },
                    'description'       => __('Serialized dataset for the visitor; can be null.', 'wp-partnershipm'),
                    'required'          => false,
                ],
            ],
        ]);
        ...
        register_rest_route('partnership/v1', '/events/(?P<event_id>\d+)', [
            'methods'             => 'GET',
            ...
            'args'                => [
                'event_id' => [
                    'validate_callback' => function($param) { return is_numeric($param); },
                    'description'       => __('Event ID for fetching details.', 'wp-partnershipm'),
                    'required'          => true,
                ],
            ],
        ]);
        ...
        register_rest_route('partnership/v1', '/events/(?P<event_id>\d+)', [
            ...
            'args'                => [
                'event_id' => [
                    'validate_callback' => function($param) { return is_numeric($param) && $param > 0; },
                    'description'       => __('Event ID for deletion.', 'wp-partnershipm'),
                    'required'          => true,
                ],
            ],
        ]);
        ...
        register_rest_route('partnership/v1', '/events/(?P<event_id>\d+)', [
            ...
            'args'                => [
                'event_id' => [
                    'validate_callback' => function($param) { return is_numeric($param); }, // ID can be 0 for create
                    'description'       => __('Event ID for updating; use 0 to create a new event.', 'wp-partnershipm'),
                    'required'          => true,
                ],
                'activity_id' => [
                    'validate_callback' => function($param) { return is_numeric($param) && $param > 0; },
                    'description'       => __('Activity ID associated with the event.', 'wp-partnershipm'),
                    'required'          => true,
                ],
                'event_type' => [
                    'validate_callback' => function($param) { return !empty($param); },
                    'description'       => __('Type of the event (stay, click, scroll).', 'wp-partnershipm'),
                    'required'          => true,
                ],
                'target' => [
                    'validate_callback' => function($param) { return is_string($param) || is_null($param); },
                    'description'       => __('Target of the event; can be null.', 'wp-partnershipm'),
                    'required'          => false,
                ],
            ],
        ]);
    ...
    public function register_scripts() {
		// Enqueue scripts.
		wp_enqueue_script('wp-partnershipm-visitor', WP_PARTNERSHIPM_BUILD_JS_URI . '/visitor.js', [], Assets::filemtime(WP_PARTNERSHIPM_BUILD_JS_DIR_PATH . '/visitor.js'), true);
        wp_localize_script('wp-partnershipm-visitor', '_visitorline', ['visit_id' => $this->_visit_id]);
	}
    ...
    private function is_tracking_condition_met() {
        return !wp_doing_ajax() && !(defined('REST_REQUEST') && REST_REQUEST) && !is_admin();
    }
