...
class Suite {
    ...
    public function register_routes() {
        ...
        register_rest_route('partnership/v1', '/elementor/forms', [
            'methods' => 'GET', 
            'callback' => [$this, 'get_elementor_forms'],
            'permission_callback' => [Security::get_instance(), 'permission_callback']
        ]);

        register_rest_route('partnership/v1', '/elementor/(?P<form_id>[\d]+)/entries', [
            'methods' => 'GET', 
        ...
        // MetForm Endpoints
        register_rest_route('partnership/v1', '/metform/forms', [
            'methods' => 'GET', 
            'callback' => [$this, 'get_metforms'],
            'permission_callback' => [Security::get_instance(), 'permission_callback']
        ]);

        register_rest_route('partnership/v1', '/metform/(?P<form_id>[\d]+)/entries', [
            'methods' => 'GET', 
		...
		register_rest_route('partnership/v1', '/woocommerce/orders', [
            'methods' => 'GET', 
        ...
        register_rest_route('partnership/v1', '/woocommerce/(?P<order_id>[\d]+)', [
            'methods' => 'GET', 
        ...
        register_rest_route('partnership/v1', '/posts/types', [
            'methods' => 'GET',
        ...
        register_rest_route('partnership/v1', '/posts/(?P<post_type>[\w-]+)', [
            'methods' => 'GET',
        ...
        register_rest_route('partnership/v1', '/posts/(?P<post_type>[\w-]+)/(?P<post_id>[\d]+)', [
            'methods' => 'GET',
        ...
        // Get site details  
        register_rest_route('partnership/v1', '/site/insights', [
            'methods' => 'GET',
