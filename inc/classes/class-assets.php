...
class Assets {
	...
	public function admin_enqueue_scripts($curr_page) {
		...
		wp_register_style('wp-partnershipm-admin', WP_PARTNERSHIPM_BUILD_CSS_URI . '/admin.css', [], $this->filemtime(WP_PARTNERSHIPM_BUILD_CSS_DIR_PATH . '/admin.css'), 'all');
		wp_register_script('wp-partnershipm-admin', WP_PARTNERSHIPM_BUILD_JS_URI . '/admin.js', [], $this->filemtime(WP_PARTNERSHIPM_BUILD_JS_DIR_PATH . '/admin.js'), true);
		wp_register_script('wp-partnershipm-setting', WP_PARTNERSHIPM_BUILD_JS_URI . '/setting.js', [], $this->filemtime(WP_PARTNERSHIPM_BUILD_JS_DIR_PATH . '/setting.js'), true);
		wp_localize_script('wp-partnershipm-admin', 'partnershipmangConfig', apply_filters('partnershipmang/siteconfig', []));
		// 
		if ($curr_page == 'settings_page_wp-partnershipm') {
			wp_enqueue_script('wp-partnershipm-setting');
		}
		// 
