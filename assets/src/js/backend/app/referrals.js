...
export const Referrals = ({ filters = 'any' }) => {
...
export const Active_Referrals = () => {
    return (
        <ReferralsScreen filters="active" />
    )
}
export const Inactive_Referrals = () => {
    return (
        <ReferralsScreen filters="inactive" />
    )
}

export const ReferralsScreen = ({ filters = 'any' }) => {
    return (
        <div className="row">
