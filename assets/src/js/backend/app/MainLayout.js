            ...
            <aside className={ `sidebar ${miniSidebar ? 'active' : ''}` }>
                ...
                <div>
                    <Link to="/" className="sidebar-logo">
                        <img src={ app_url('/src/img/logo.png') } alt={__('Site logo')} className="light-logo" />
                        <img src={ app_url('/src/img/logo-light.png') } alt={__('Site logo')} className="dark-logo" />
                        <img src={ app_url('/src/img/logo-icon.png') } alt={__('Site logo')} className="logo-icon" />
                    </Link>
                </div>
