            ...
            >
                ...
                <ul className="to-top-list">
                    <li>
                        ...
                        <Icon icon="solar:user-linear" className="icon text-xl" />  {__('My Profile')}</Link>
                    </li>
                    <li>
                        ...
                        <Icon icon="tabler:message-check" className="icon text-xl" />  {__('Inbox')}</Link>
                    </li>
                    <li>
                        ...
                        <Icon icon="icon-park-outline:setting-two" className="icon text-xl" />  {__('Setting')}</Link>
                    </li>
                    <li>
                        ...
                        <Icon icon="lucide:power" className="icon text-xl" />  {__('Log Out')}</Link>
                    </li>
                </ul>
            </div>
        </div>
